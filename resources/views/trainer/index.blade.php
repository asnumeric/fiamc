...
@section('card-action-btn')
    @if(Gate::check('manage trainer'))
        <a class="btn btn-primary btn-sm ml-20 customModal" href="#" data-size="lg"
           data-url="{{ route('trainers.create') }}"
           data-title="{{__('Create Trainer')}}"> <i
                    ...
                    <table class="display dataTable cell-border datatbl-advance">
                        ...
                        @foreach ($trainers as $trainer)
                            ...
                            <tr>
                                ...
                                <td class="table-user">
                                    <img
                                        src="{{!empty($trainer->avatar)?asset(Storage::url('upload/profile')).'/'.$trainer->avatar:asset(Storage::url('upload/profile')).'/avatar.png'}}"
